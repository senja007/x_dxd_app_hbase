...
class WelcomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final welcomeFirstHalfAnimation = Tween<Offset>(begin: const Offset(2, 0), end: const Offset(0, 0)).animate(CurvedAnimation(
      parent: animationController,
      curve: const Interval(
        0.6,
        0.8,
    ...
    final welcomeImageAnimation = Tween<Offset>(begin: const Offset(4, 0), end: const Offset(0, 0)).animate(CurvedAnimation(
      parent: animationController,
      curve: const Interval(
        0.6,
        0.8,
              ...
              children: [
                SlideTransition(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(
                      'assets/images/start/welcome.png',
                      fit: BoxFit.contain,
                    ),
                  ),
                ),
